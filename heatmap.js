...
class NetworkSimulator {
    ...
    generateMetrics(state, baseMetrics) {
        ...
        return {
            ...
            latency: Number(metrics.latency.toFixed(2)),
            bandwidth: Number(metrics.bandwidth.toFixed(2)),
            reliability: Number(metrics.reliability.toFixed(2))
        };
    }
    ...
    adjustMetric(baseValue, multiplier, hasIssue, variationScale = 1) {
        ...
        // Ensure values stay within reasonable bounds and round to 2 decimal places
